            ...
            <div class="w-full max-w-[420px]">
                <div
                    ...
                    <p class="text-sm text-gray-500 mb-8 text-center">
                        Join AyurCare for personalized health
                    </p>
                    ...
                    <div class="relative text-center mb-8">
                        ...
                        <span class="relative px-4 bg-white text-xs text-gray-400 uppercase tracking-wider">or sign up
                            with email</span>
                    </div>
                    ...
                    <form method="POST" action="{{ route('register') }}" class="space-y-4">
                        ...
                        <div>
                            <label for="name" class="block text-sm font-medium text-gray-500 mb-1.5 ml-1">Full
                                Name</label>
                            <input id="name" type="text" name="name" value="{{ old('name') }}" required autofocus class="w-full px-4 py-3 bg-white border border-gray-200 rounded-lg text-gray-900 text-sm placeholder-gray-400
                        ...
                        <div>
                            <label for="email" class="block text-sm font-medium text-gray-500 mb-1.5 ml-1">Email
                                Address</label>
                            <input id="email" type="email" name="email" value="{{ old('email') }}" required class="w-full px-4 py-3 bg-white border border-gray-200 rounded-lg text-gray-900 text-sm placeholder-gray-400
                                          focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500
                                          transition-colors duration-200" />
                        </div>
                        ...
                        <div>
                            ...
                            <input id="password" type="password" name="password" required class="w-full px-4 py-3 bg-white border border-gray-200 rounded-lg text-gray-900 text-sm placeholder-gray-400
                                          focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500
                                          transition-colors duration-200" />
                        </div>
                        ...
                        <div>
                            <label for="password_confirmation"
                                class="block text-sm font-medium text-gray-500 mb-1.5 ml-1">Confirm Password</label>
                    ...
                    <p class="text-sm text-center text-gray-500 mt-8">
                        ...
                        <a href="{{ route('login', ['role' => $role]) }}"
                            class="text-blue-600 hover:text-blue-700 font-medium">Login</a>
                    </p>
                </div>
            </div>
        ...
        <div class="lg:hidden w-full max-w-sm">
            <div class="bg-white rounded-xl p-6 shadow-lg border border-gray-100">
                ...
                <form method="POST" action="{{ route('register') }}" class="space-y-4">
                    ...
                    <div>
                        <label class="block text-xs font-medium text-gray-500 mb-1 ml-1">FULL NAME</label>
                    ...
                    <div>
                        <label class="block text-xs font-medium text-gray-500 mb-1 ml-1">CONFIRM PASSWORD</label>
                ...
                <div class="mt-6 text-center">
                    <p class="text-sm text-gray-600">
                        Already have an account? <a href="{{ route('login', ['role' => $role]) }}"
                            class="text-blue-600 font-medium">Login</a>
                    </p>
                </div>
            </div>
        </div>
